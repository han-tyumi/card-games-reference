...
**50 entries, checked 2026-08-01** — pagat and Wikipedia, fetched and read
...
**10 entries, checked 2026-08-03** — the solitaires and light games the
...
`klondike`, `koi-koi`, `mau-mau`, `pyramid`, `speed`.
